angular.module('starter', ['ui.router', 'starter.controllers.credit_case_in', 'starter.controllers.nav', 'starter.controllers.login'])
    ...
    .factory('handhttp', ['$rootScope', '$http', function($http, $rootScope, permissions) {
        return {
    ...
    .directive('hasPermission', ['$rootScope', function(permissions, $rootScope, handhttp, permissionsq) {
        // $http({
        //     url: 'server.php?action=authlist',
        //     method: 'POST'
        // }).success(function(data, header, config, status) {
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                var auth, value = attrs.hasPermission.trim();
